  ...
  <a href="reg-students.php">
               <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-danger back-widget-set text-center">
                            ...
                            <?php 
$sql3 ="SELECT id from tblstudents where status=1 Or status = 0 ";
...
<a href="reg-student-pending.php">
 <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-success back-widget-set text-center">
                            <i class="fa fa-spinner fa-key fa-5x"></i>
<?php 
$sq4 ="SELECT id from tblstudents where Status=-1 ";
$query4 = $dbh -> prepare($sq4);
$query4->execute();
$results4=$query4->fetchAll(PDO::FETCH_OBJ);
$listdathrs=$query4->rowCount();
