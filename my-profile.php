...
<?php 
$sid=$_SESSION['stdid'];
$sql="SELECT StudentId,FullName,EmailId,MobileNumber,RegDate,UpdationDate,profileImage,Status from  tblstudents  where StudentId=:sid ";
$query = $dbh -> prepare($sql);
$query-> bindParam(':sid', $sid, PDO::PARAM_STR);
$query->execute();
...
<img src="profileimg/<?php echo htmlentities($result->profileImage);?>" width="100">
</td>
<br>
<div class="form-group">
<label>User ID : </label>
